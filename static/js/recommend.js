...
function redirectToEveryTime() {
    var userAgent = navigator.userAgent || navigator.vendor || window.opera;

    if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
        window.location = "https://apps.apple.com/kr/app/%EC%97%90%EB%B8%8C%EB%A6%AC%ED%83%80%EC%9E%84/id642416310?l=en-GB";
    } else if (/android/i.test(userAgent)) {
        window.location = "https://play.google.com/store/apps/details?id=com.everytime.v2";
    } else {
        alert("이 링크는 모바일 디바이스에서만 사용 가능합니다.");
    }
}
...
function loadContent(type) {
    ...
    if (type === 'apps') {
        ...
        content = `
            ...
            <div class="link-container">
            <a href="#" onclick="redirectToEveryTime(); return false;" class="custom-link">
                <img src="static/images/RM_app_icon_13.png" alt="Icon" class="link-icon">
                <span class="link-text">
                    <span class="link-text-title">에브리타임</span>
                    <span class="link-text-sub">시간표 관리 및 커뮤니티 앱</span>
                </span>
                <img src="static/images/arrow.png" alt="Arrow" class="link-arrow">
            </a>
        </div>
